...
#------------------------------------------------------------------
            ...
            if funcation_key==1:
                ...
                blance1=pasword_username_chack(name,name,name,str(acount_number2))
                if blance==0:
                ...
                if acount_number2==acount_number3:
                    try:
                        money=int(input("inter your transfer amount="))
                    except ValueError:
                        print("\033[31m---ERROR____Enter Money Value Only---- [UCB]\033[0m")
                        continue
                    if money<blance:
                        print("--------------")
                        new_blance=blance_edeter(name,str(acount_number),money,"withrow")
                        new_blance1=blance_edeter(name,str(acount_number2),money,"deposit")
                            ...
                            #      continue
                                ...
                                if acount_number2==acount_number3:
                                    try:
                                        ...
                                        continue
                                    if money<blance:
                                        new_blance=blance_edeter(admin_id,str(acount_number),money,"withrow")
                                        new_blance1=blance_edeter(admin_id,str(acount_number2),money,"deposit")
                                        print("user new blance=",new_blance)
                                    else:
